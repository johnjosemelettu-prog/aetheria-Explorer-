...
export default function DashboardPage() {
  ...
  const handleMissionInvite = (name: string) => {
    toast({
      title: t('dashboard.toast.missionInviteTitle'),
      description: t('dashboard.toast.missionInviteDescription', { name }),
    });
  };
                ...
                <CardContent className="p-5 md:p-10 space-y-8 md:space-y-10">
                  <div className="space-y-4">
                    <div className="flex justify-between items-end">
                      ...
                      <p className="text-[10px] font-black text-foreground tracking-widest uppercase">{t('dashboard.xpProgress', { current: 850, total: 1000 })}</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-6">
                    <div className="p-5 md:p-6 rounded-2xl md:rounded-[2rem] bg-muted/50 border border-border flex items-center gap-4 group hover:bg-primary/5 transition-all active:scale-95">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-black tracking-tight uppercase italic">{t('dashboard.odysseyCount', { count: 5 })}</p>
                      </div>
                    </div>
                    <div className="p-5 md:p-6 rounded-2xl md:rounded-[2rem] bg-muted/50 border border-border flex items-center gap-4 group hover:bg-primary/5 transition-all active:scale-95">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-black tracking-tight uppercase italic">{t('dashboard.questCount', { count: 42 })}</p>
                      </div>
                    </div>
                    <div className="p-5 md:p-6 rounded-2xl md:rounded-[2rem] bg-muted/50 border border-border flex items-center gap-4 group hover:bg-primary/5 transition-all active:scale-95">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-black tracking-tight uppercase italic">{t('dashboard.awardCount', { count: 12 })}</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <Card id="vibe-radar" className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card text-card-foreground p-5 md:p-8 border border-border overflow-hidden relative">
              ...
              <div className="relative z-10">
                    ...
                    <div key={idx} className="flex items-center justify-between group cursor-pointer hover:bg-muted/50 p-2 -mx-1 rounded-xl transition-all">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <Badge variant="outline" className="text-[6px] md:text-[7px] font-black uppercase tracking-widest py-0 px-1.5 border-primary/20 text-primary mt-1">{viber.vibe} {t('dashboard.match')}</Badge>
                        </div>
                      </div>
                      <Button 
                        size="icon" 
                ...
                <Button asChild variant="outline" className="w-full mt-6 md:mt-8 rounded-xl md:rounded-2xl h-11 md:h-12 font-black border-2 border-border hover:bg-muted transition-all uppercase tracking-widest text-[9px]">
                  <Link href="/transit-connect">{t('dashboard.expandNeuralNetwork')}</Link>
                </Button>
              </div>
            </Card>
          </aside>
