              ...
              <div className="grid grid-cols-1 items-end gap-6 md:grid-cols-2 lg:grid-cols-5">
                <FormField control={form.control} name="location" render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    <FormLabel className="font-bold text-slate-700">Location Node</FormLabel>
                    <FormControl><Input placeholder="City or District" {...field} className="rounded-xl h-12" /></FormControl>
                  </FormItem>
                )} />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel className="font-bold text-slate-700">Date Node</FormLabel>
                      <Popover>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold">Temporal Node</FormLabel>
